...
En este capítulo se analizan los detalles de implementación de un bot de Telegram con las funcionalidades mostradas en el Capítulo~\ref{chapter:proposal}. En la sección~\ref{sec:technical-details} se mencionan las tecnologías y herramientas utilizadas en la implementación del bot. En la sección~\ref{sec:features} se analiza la implementación de cada una de las funcionalidades.
...
En este capítulo se mostraron las particularidades del sistema de acuerdo a su implementación.
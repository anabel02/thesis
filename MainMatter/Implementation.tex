...
Si el nombre del tema no resulta suficientemente claro, el estudiante puede solicitar una descripción detallada del mismo. Este flujo se ilustra en la \Cref{fig:topics} de la página~\pageref{fig:topics}.
...
En la \Cref{fig:json} de la página~\pageref{fig:json}, se muestra un ejemplo del archivo \texttt{topics.json} con un tema y un ejercicio:
